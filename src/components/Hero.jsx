...
const Hero = () => {
  return (
    <section className="mx-auto flex flex-col gap-10 pt-30 sm:pt-60">
      ...
      <button className="bg-primary hover:bg-[#0697eb] transition-colors duration-200 font-bold text-xs mx-auto w-fit rounded cursor-pointer px-3 py-2 sm:px-5 sm:py-3">
        Join Us
      </button>
    </section>
  );
